  ...
  return (
    <div className="flex  items-center justify-center">
      <div className="relative flex flex-col rounded-xl bg-transparent my-32 border-2 px-12 py-12  bg-clip-border  shadow-none">
        ...
        {/* https://validation-task-88620-default-rtdb.firebaseio.com */}
        {/* <p>{JSON.stringify(inputValue.user)}</p> */}
        {/* json stringify json data ko show krata hai direct browserr par */}
      </div>
    </div>
  );
};
